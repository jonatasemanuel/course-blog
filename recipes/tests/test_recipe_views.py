...
class RecipeViewsTest(RecipeTestBase):
    ...
    def test_recipe_category_view_returns_404_if_no_recipes_fund(self):
    ...
    def test_recipe_category_template_do_not_published_load(self):
        """Test recipe is_published False dont shows"""
        # need a recipe for this test
    ...
    def test_recipe_detail_view_returns_404_if_no_recipes_fund(self):
        response = self.client.get(
